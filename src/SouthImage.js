  ...
  return (
    <div 
      className="
        ...
        rounded m-1 bg-cover bg-center h-64 w-99"
      style={{
         backgroundImage: `url(${southImage})` ,
         gridTemplateRows: 'repeat(7, 1fr)' 
      }}
    >
      <div className="text-left col-start-2 col-end-4 row-start-2">
      ...
      <div className="text-left text-pretty col-start-4 col-span-2 row-start-4">
        of Palestine!
      </div>
